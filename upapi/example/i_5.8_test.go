...
func Test_CouponDownload(t *testing.T) {
	r, err := upapi.CouponDownload(appid_14525f83bb3c4dd68eca6511c93cb5ef, &upapi.CouponDownloadParams{
...
func Test_Notify(t *testing.T) {
	...
	http.Handle("/coupon/notify.do", upsdk.CouponNotifyHandler(func(appid string) (cfg *upsdk.Config, err error) {
		cfg = &upsdk.Config{
		...
		return
	}, func(req *http.Request, requestId string, notifyResult *upsdk.CouponNotify) error {
